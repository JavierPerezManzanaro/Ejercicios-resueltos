...
def c22_promedio():
    ...
    for key,value in notas.items():
        suma_notas+=value[3]
    print("El promedio de las notal del estudiante es de : ",suma_notas/len(notas))
# Llamar funciones, y mostrar Resultados
print("\n------------------------ Punto 2 ------------------------")
print('Caso 2: Diccionario de Listas')
c21_final()
c22_promedio()
pprint(notas)
...
# Llamar funciones, y mostrar Resultados
print("\n------------------------ Punto 3 ------------------------")
print('Caso 3: Diccionario de Diccionarios')
c31_final()
c32_promedio()
pprint(notas)
...
def c42_promedio():
    ...
    print("El promedio de notas del estudiante es : ",suma_notas/len(notas))
# Llamar funciones, y mostrar Resultados
print("\n------------------------ Punto 4 ------------------------")
print('Caso 4: Lista de Diccionarios')
c41_final()
c42_promedio()
pprint(notas)
